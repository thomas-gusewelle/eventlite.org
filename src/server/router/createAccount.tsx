...
export const createAccountRouter = createTRPCRouter({
  ...
  getUserFromInvite: publicProcedure
    .input(z.string())
  ...
  createInviteLinkWithID: loggedInProcedure
    .input(
      z.object({
        userId: z.string(),
      })
  ...
  resendConfirm: publicProcedure
    ...
    .mutation(async ({ ctx, input }) => {
    // Check to ensure that the user requesting the confirmation email exists and is part of an organization.
  ...
  createInviteLogin: publicProcedure
    .input(
      z.object({
        email: z.string().email(),
        password: z.string(),
  ...
  generateResetPassword: publicProcedure
    .input(
      z.object({
        email: z.string().email(),
      })
  ...
  registerBetaInterest: publicProcedure
    .input(
      z.object({
        firstName: z.string(),
        lastName: z.string(),
