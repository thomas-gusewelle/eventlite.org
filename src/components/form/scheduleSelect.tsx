...
export const ScheduleSelect: React.FC<{
	...
	return (
		<div className=" block w-full border border-gray-200 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
			<Listbox value={selected} onChange={(value) => setSelected(value)}>
				<div className="relative ">
					<Listbox.Button
						...
						<div className="flex h-full min-h-[1.5rem] flex-wrap">
							{selected.name || ""}
						</div>
